// FOREIGN
var proxy_hk = 'PROXY your_proxy_url_foreign1:8080; PROXY your_proxy_url_foreign2:8080;';
// ALL
var proxy = 'PROXY your_proxy_url_internal; PROXY your_proxy_url_internal2:8080;';
...
function FindProxyForURL(url, host) {
    ...
    for (var i = 0; i < no_proxy.length; i++) {
        lastNoProxy = no_proxy[i];
        if (host == lastNoProxy || host.endsWith('.' + lastNoProxy))
            return 'DIRECT';
    };
